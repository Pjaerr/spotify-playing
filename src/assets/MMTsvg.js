...
const MMTsvg = props => {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 682.1 107.9" className="mmt-logo">
      <g>
        <path className="st1" d="M518.8,60.4v-6.5h18.9v23.3c-3.6,2-10.6,4.5-18.8,4.5c-16.2,0-27-11.3-27-27c0-16.6,11.6-28.2,28.8-28.2
        ...
        <path className="st0" d="M56.1,54.9c-11.7,32.2-28.7,48-42.6,53L0,94.5c5.7-7,13.4-19.2,20.8-39.7C34.5,17.5,55.6,1.4,71.6,0l10,10
        C74.4,17,64.7,31.1,56.1,54.9"></path>
        <path className="st0" d="M100.1,54.9c-11.7,32.2-28.7,48-42.6,53L44,94.5c5.7-7,13.4-19.2,20.8-39.7C78.5,17.5,99.6,1.4,115.6,0l10,10
        C118.4,17,108.7,31.1,100.1,54.9"></path>
        <path className="st0" d="M144.1,54.9c-11.7,32.2-28.7,48-42.6,53L88,94.5c5.7-7,13.4-19.2,20.8-39.7C122.5,17.5,143.6,1.4,159.6,0
